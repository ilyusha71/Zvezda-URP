...
namespace Warfare.Unit
{
    public class DatabaseEditor : EditorWindow
    {
        ...
        void DrawDatabaseInspector()
        {
            ...
            GUILayout.Space(5);
            foreach (KeyValuePair<Unit.Type, Unit.Info> unit in database.data.ToList())
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.Space(5);
                    source = EditorGUILayout.ObjectField(unit.Value, typeof(Unit.Info), true, GUILayout.Width(100)) as Unit.Info;
