...
public class CubeMesh : MonoBehaviour
{
    ...
    [MenuItem ("Dev/Make 4 faces cube mesh - XY Symmetry")]
    static void Make4FacesCubeMesh_XY_Symmetry ()
    {
        GameObject obj = Selection.activeGameObject;
        if (obj.GetComponent<MeshRenderer> () == null)
        {
    ...
    [MenuItem ("Dev/Make 4 faces cube mesh - X Symmetry - Y Mirror")]
    static void Make4FacesCubeMesh_X_Symmetry_Y_Mirror ()
    {
        GameObject obj = Selection.activeGameObject;
        if (obj.GetComponent<MeshRenderer> () == null)
        {
        ...
        UVs[5] = new Vector2 (1.0f, 0.5f); // 右上
        // Bottom ( y- )
        UVs[12] = new Vector2 (0.5f, 0.5f); // 左下
        UVs[13] = new Vector2 (0.5f, 0.0f); // 左上
        UVs[14] = new Vector2 (1.0f, 0.0f); // 右上
        UVs[15] = new Vector2 (1.0f, 0.5f); // 右下
        // Right ( x- )
        UVs[16] = new Vector2 (0.5f, 0.5f); // 左下
        UVs[17] = new Vector2 (0.5f, 1.0f); // 左上
        UVs[18] = new Vector2 (1.0f, 1.0f); // 右上
    ...
    [MenuItem ("Dev/Make 4 faces cube mesh - X Mirror - Y Symmetry")]
    static void Make4FacesCubeMesh_X_Mirror_Y_Symmetry ()
    {
        GameObject obj = Selection.activeGameObject;
        if (obj.GetComponent<MeshRenderer> () == null)
        {
        ...
        UVs[15] = new Vector2 (1.0f, 0.0f); // 右下
        // Right ( x- )
        UVs[16] = new Vector2 (1.0f, 0.5f); // 左下
        UVs[17] = new Vector2 (1.0f, 1.0f); // 左上
        UVs[18] = new Vector2 (0.5f, 1.0f); // 右上
        UVs[19] = new Vector2 (0.5f, 0.5f); // 右下
        // Left ( x+ )        
        UVs[20] = new Vector2 (0.5f, 0.5f); // 左下
        UVs[21] = new Vector2 (0.5f, 1.0f); // 左上
        UVs[22] = new Vector2 (1.0f, 1.0f); // 右上
